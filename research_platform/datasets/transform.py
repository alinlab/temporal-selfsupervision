...
def flip_images(images, boxes=None):
    """
...
def crop_images(images, size, x_offset, y_offset):
    """
...
def random_short_side_scale_jitter(
    ...
    images, boxes = short_side_scale_jitter(images, size, boxes)
    return (
        images,
        boxes,
        size
...
def random_crop(images, size, boxes=None):
    ...
    cropped = crop_images(images, size, x_offset, y_offset)
    cropped_boxes = (
...
def horizontal_flip(prob, images, boxes=None, sample=None):
    """
    Perform horizontal flip on the given images and corresponding boxes.
    Args:
        prob (float): probility to flip the images.
    ...
    return images, flipped_boxes, sample
